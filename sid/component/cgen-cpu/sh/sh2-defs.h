...
// write stacks used in parallel execution
  ...
  // unified writeback function (defined in sh2-write.cc)
  void writeback (int tick, sh2::sh2_cpu* current_cpu);
  // unified write-stack clearing function (defined in sh2-write.cc)
  void reset ();

  }; // end struct sh2::write_stacks 
