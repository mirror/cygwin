/* CPU family header for sh2a_fpu / sh2a_fpu.
...
#ifndef DEFS_SH2A_FPU_H
#define DEFS_SH2A_FPU_H
...
// write stacks used in parallel execution
  ...
  // unified writeback function (defined in sh2a_fpu-write.cc)
  void writeback (int tick, sh2a_fpu::sh2a_fpu_cpu* current_cpu);
  // unified write-stack clearing function (defined in sh2a_fpu-write.cc)
  void reset ();

  }; // end struct sh2a_fpu::write_stacks 

} // end sh2a_fpu namespace

#endif /* DEFS_SH2A_FPU_H */
