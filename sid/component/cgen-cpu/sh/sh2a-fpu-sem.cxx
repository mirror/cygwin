/* Simulator instruction semantics for sh2a_fpu.
...
void
sh2a_fpu_sem_add_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
...
void
sh2a_fpu_sem_addi_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
...
void
sh2a_fpu_sem_addc_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_macl_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_addv_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_macl_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_and_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
...
void
sh2a_fpu_sem_andi_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
...
void
sh2a_fpu_sem_andb_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_andi_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_bf_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
...
void
sh2a_fpu_sem_bfs_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_bf_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
current_cpu->save_delayed_pc (FLD (i_disp8));
  {
    UDI opval = FLD (i_disp8);
    buf.h_pc_writes [(tick + 1) % sh2a_fpu::pipe_sz].push (sh2a_fpu::write<UDI>(pc, opval));
    if (UNLIKELY(current_cpu->trace_result_p))
      current_cpu->trace_stream << "pc" << ":=0x" << hex << opval << dec << "  ";
  }
}
...
void
sh2a_fpu_sem_bra_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
...
void
sh2a_fpu_sem_braf_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
...
void
sh2a_fpu_sem_bsr_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_bra_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...

{
  {
    SI opval = ADDDI (pc, 4);
    buf.h_pr_writes [(tick + 1) % sh2a_fpu::pipe_sz].push (sh2a_fpu::write<SI>(pc, opval));
    if (UNLIKELY(current_cpu->trace_result_p))
...
void
sh2a_fpu_sem_bsrf_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_stsl_fpul_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_bt_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_bf_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_bts_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_bf_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_cmpeq_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
...
void
sh2a_fpu_sem_cmpeqi_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_andi_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_cmpge_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_movl13_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_cmpgt_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_movl13_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_cmphi_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_movl13_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_cmphs_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_movl13_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_cmppl_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_stsl_fpul_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_cmppz_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_stsl_fpul_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_cmpstr_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_movl13_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_div0s_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_movl13_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_div1_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_macl_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_divu_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
...
void
sh2a_fpu_sem_mulr_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_divu_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_dmulsl_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_movl13_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_dmulul_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_movl13_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_dt_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_stsl_fpul_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_extsb_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
...
void
sh2a_fpu_sem_extsw_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_movl12_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_extub_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_movl12_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_extuw_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_movl12_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_fabs_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
...
void
sh2a_fpu_sem_fadd_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_fadd_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_fcmpeq_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_fadd_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_fcmpgt_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_fadd_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_fcnvds_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
...
void
sh2a_fpu_sem_fcnvsd_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
...
void
sh2a_fpu_sem_fdiv_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_fadd_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_flds_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
...
void
sh2a_fpu_sem_fldi0_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
...
void
sh2a_fpu_sem_fldi1_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_fsts_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_float_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
...
void
sh2a_fpu_sem_fmac_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
...
void
sh2a_fpu_sem_fmov1_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
...
void
sh2a_fpu_sem_fmov2_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
...
void
sh2a_fpu_sem_fmov3_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
...
void
sh2a_fpu_sem_fmov4_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_fmov4_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_fmov5_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
...
void
sh2a_fpu_sem_fmov6_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
...
void
sh2a_fpu_sem_fmov7_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_fmov7_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_fmov8_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
...
void
sh2a_fpu_sem_fmov9_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
...
void
sh2a_fpu_sem_fmul_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_fadd_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_fneg_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_fadd_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_fsqrt_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_fadd_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_fsts_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_fsts_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_fsub_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_fadd_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_ftrc_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
...
void
sh2a_fpu_sem_jmp_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_stsl_fpul_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_jsr_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_stsl_fpul_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_ldc_gbr_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_stsl_fpul_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_ldc_vbr_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_stsl_fpul_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_ldc_sr_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_stsl_fpul_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_ldcl_gbr_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_stsl_fpul_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_ldcl_vbr_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_stsl_fpul_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_lds_fpscr_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_stsl_fpul_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_ldsl_fpscr_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_stsl_fpul_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_lds_fpul_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
...
void
sh2a_fpu_sem_ldsl_fpul_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_ldsl_fpul_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_lds_mach_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_stsl_fpul_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_ldsl_mach_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_stsl_fpul_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_lds_macl_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_stsl_fpul_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_ldsl_macl_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_stsl_fpul_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_lds_pr_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_stsl_fpul_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_ldsl_pr_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_stsl_fpul_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_macl_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_macl_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_macw_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_macl_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_mov_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_and_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_movi_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_addi_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_movi20_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
...
void
sh2a_fpu_sem_movb1_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_movl13_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_movb2_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_macl_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_movb3_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
...
void
sh2a_fpu_sem_movb4_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_andi_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_movb5_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
...
void
sh2a_fpu_sem_movb6_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_movl12_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_movb7_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_macl_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_movb8_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
...
void
sh2a_fpu_sem_movb9_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_andi_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_movb10_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
...
void
sh2a_fpu_sem_movl1_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_movl13_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_movl2_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_macl_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_movl3_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_movb3_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_movl4_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
...
void
sh2a_fpu_sem_movl5_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
...
void
sh2a_fpu_sem_movl6_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_movl12_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_movl7_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_macl_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_movl8_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_movb8_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_movl9_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
...
void
sh2a_fpu_sem_movl10_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
...
void
sh2a_fpu_sem_movl11_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
...
void
sh2a_fpu_sem_movl12_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_movl12_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_movl13_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_movl13_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_movw1_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_movl13_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_movw2_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_macl_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_movw3_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_movb3_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_movw4_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
...
void
sh2a_fpu_sem_movw5_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
...
void
sh2a_fpu_sem_movw6_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_movl12_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_movw7_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_macl_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_movw8_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_movb8_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_movw9_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
...
void
sh2a_fpu_sem_movw10_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
...
void
sh2a_fpu_sem_movw11_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
...
void
sh2a_fpu_sem_mova_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_movl9_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_movt_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_movw10_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_mull_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_movl13_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_mulsw_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_movl13_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_muluw_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_movl13_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_neg_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_movl12_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_negc_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_movl12_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_not_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_and_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_or_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_and_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_ori_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_andi_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_orb_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_andi_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_rotcl_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_stsl_fpul_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_rotcr_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_stsl_fpul_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_rotl_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_stsl_fpul_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_rotr_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_stsl_fpul_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_shad_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_macl_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_shal_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_stsl_fpul_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_shar_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_stsl_fpul_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_shll_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_stsl_fpul_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_shll2_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_stsl_fpul_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_shll8_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_stsl_fpul_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_shll16_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_stsl_fpul_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_shlr_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_stsl_fpul_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_shlr2_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_stsl_fpul_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_shlr8_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_stsl_fpul_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_shlr16_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_stsl_fpul_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_stc_gbr_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_movw10_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_stc_vbr_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_movw10_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_stcl_gbr_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_stsl_fpul_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_stcl_vbr_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_stsl_fpul_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_sts_fpscr_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_movw10_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_stsl_fpscr_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_stsl_fpul_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_sts_fpul_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_stsl_fpul_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_stsl_fpul_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_stsl_fpul_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_sts_mach_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_movw10_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_stsl_mach_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_stsl_fpul_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_sts_macl_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_movw10_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_stsl_macl_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_stsl_fpul_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_sts_pr_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_movw10_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_stsl_pr_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_stsl_fpul_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_sub_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_macl_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_subc_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_macl_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_subv_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_macl_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_swapb_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_movl12_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_swapw_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_movl12_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_tasb_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_stsl_fpul_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_trapa_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_andi_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_tst_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_movl13_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_tsti_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_andi_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_tstb_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_andi_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_xor_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_and_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_xori_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_andi_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_xorb_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_andi_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh2a_fpu_sem_xtrct_compact (sh2a_fpu_cpu* current_cpu, sh2a_fpu_scache* sem, const int tick, 
	sh2a_fpu::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_macl_compact.f
  sem_status status = SEM_STATUS_NORMAL;
