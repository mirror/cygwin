/* Simulator instruction semantics for sh3.
...
void
sh3_sem_add_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
...
void
sh3_sem_addi_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
...
void
sh3_sem_addc_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_macl_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_addv_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_macl_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_and_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
...
void
sh3_sem_andi_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
...
void
sh3_sem_andb_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_andi_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_bf_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
...
void
sh3_sem_bfs_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_bf_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
current_cpu->save_delayed_pc (FLD (i_disp8));
  {
    UDI opval = FLD (i_disp8);
    buf.h_pc_writes [(tick + 1) % sh3::pipe_sz].push (sh3::write<UDI>(pc, opval));
    if (UNLIKELY(current_cpu->trace_result_p))
      current_cpu->trace_stream << "pc" << ":=0x" << hex << opval << dec << "  ";
  }
}
...
void
sh3_sem_bra_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
...
void
sh3_sem_braf_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_addi_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_bsr_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_bra_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...

{
  {
    SI opval = ADDDI (pc, 4);
    buf.h_pr_writes [(tick + 1) % sh3::pipe_sz].push (sh3::write<SI>(pc, opval));
    if (UNLIKELY(current_cpu->trace_result_p))
...
void
sh3_sem_bsrf_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_addi_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_bt_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_bf_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_bts_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_bf_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_cmpeq_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
...
void
sh3_sem_cmpeqi_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_andi_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_cmpge_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_movl5_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_cmpgt_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_movl5_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_cmphi_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_movl5_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_cmphs_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_movl5_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_cmppl_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_addi_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_cmppz_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_addi_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_cmpstr_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_movl5_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_div0s_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_movl5_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_div1_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_macl_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_dmulsl_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_movl5_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_dmulul_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_movl5_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_dt_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_addi_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_extsb_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
...
void
sh3_sem_extsw_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_movl11_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_extub_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_movl11_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_extuw_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_movl11_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_jmp_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_addi_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_jsr_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_addi_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_ldc_gbr_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_addi_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_ldc_vbr_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_addi_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_ldc_sr_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_addi_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_ldcl_gbr_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_addi_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_ldcl_vbr_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_addi_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_lds_mach_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_addi_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_ldsl_mach_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_addi_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_lds_macl_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_addi_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_ldsl_macl_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_addi_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_lds_pr_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_addi_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_ldsl_pr_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_addi_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_macl_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_macl_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_macw_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_macl_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_mov_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_and_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_movi_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_addi_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_movb1_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_movl5_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_movb2_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_macl_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_movb3_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
...
void
sh3_sem_movb4_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_andi_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_movb5_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
...
void
sh3_sem_movb6_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_movl11_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_movb7_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_macl_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_movb8_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
...
void
sh3_sem_movb9_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_andi_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_movb10_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
...
void
sh3_sem_movl1_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_movl5_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_movl2_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_macl_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_movl3_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_movb3_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_movl4_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
...
void
sh3_sem_movl5_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_movl5_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_movl6_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_movl11_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_movl7_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_macl_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_movl8_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_movb8_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_movl9_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
...
void
sh3_sem_movl10_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
...
void
sh3_sem_movl11_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_movl11_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_movw1_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_movl5_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_movw2_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_macl_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_movw3_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_movb3_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_movw4_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
...
void
sh3_sem_movw5_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
...
void
sh3_sem_movw6_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_movl11_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_movw7_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_macl_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_movw8_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_movb8_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_movw9_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
...
void
sh3_sem_movw10_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
...
void
sh3_sem_movw11_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
...
void
sh3_sem_mova_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_movl9_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_movt_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_movw10_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_mull_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_movl5_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_mulsw_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_movl5_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_muluw_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_movl5_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_neg_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_movl11_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_negc_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_movl11_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_not_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_and_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_or_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_and_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_ori_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_andi_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_orb_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_andi_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_pref_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_addi_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_rotcl_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_addi_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_rotcr_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_addi_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_rotl_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_addi_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_rotr_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_addi_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_shad_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_macl_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_shal_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_addi_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_shar_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_addi_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_shld_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_macl_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_shll_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_addi_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_shll2_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_addi_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_shll8_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_addi_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_shll16_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_addi_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_shlr_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_addi_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_shlr2_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_addi_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_shlr8_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_addi_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_shlr16_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_addi_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_stc_gbr_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_movw10_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_stc_vbr_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_movw10_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_stcl_gbr_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_addi_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_stcl_vbr_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_addi_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_sts_mach_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_movw10_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_stsl_mach_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_addi_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_sts_macl_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_movw10_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_stsl_macl_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_addi_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_sts_pr_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_movw10_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_stsl_pr_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_addi_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_sub_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_macl_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_subc_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_macl_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_subv_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_macl_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_swapb_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_movl11_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_swapw_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_movl11_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_tasb_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_addi_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_trapa_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_andi_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_tst_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_movl5_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_tsti_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_andi_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_tstb_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_andi_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_xor_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_and_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_xori_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_andi_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_xorb_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_andi_compact.f
  sem_status status = SEM_STATUS_NORMAL;
...
void
sh3_sem_xtrct_compact (sh3_cpu* current_cpu, sh3_scache* sem, const int tick, 
	sh3::write_stacks &buf)
{
#define FLD(f) abuf->fields.sfmt_macl_compact.f
  sem_status status = SEM_STATUS_NORMAL;
