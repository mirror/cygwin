...
// write stacks used in parallel execution
  ...
  // unified writeback function (defined in sh4-write.cc)
  void writeback (int tick, sh4::sh4_cpu* current_cpu);
  // unified write-stack clearing function (defined in sh4-write.cc)
  void reset ();

  }; // end struct sh4::write_stacks 
