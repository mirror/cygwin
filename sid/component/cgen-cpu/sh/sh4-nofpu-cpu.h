/* CPU class elements for sh4_nofpu.
...
// CPU state information.
  ...
  void stream_cgen_write_stacks (std::ostream &ost, const sh4_nofpu::write_stacks &stacks) const 
  {
    stream_stacks ( stacks.h_pc_writes, ost);
    stream_stacks ( stacks.h_pr_writes, ost);
  }
  void destream_cgen_write_stacks (std::istream &ist, sh4_nofpu::write_stacks &stacks) 
  {
