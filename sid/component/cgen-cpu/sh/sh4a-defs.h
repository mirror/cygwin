/* CPU family header for sh4a / sh4a.
...
// write stacks used in parallel execution
  ...
  // unified writeback function (defined in sh4a-write.cc)
  void writeback (int tick, sh4a::sh4a_cpu* current_cpu);
  // unified write-stack clearing function (defined in sh4a-write.cc)
  void reset ();

  }; // end struct sh4a::write_stacks 
