/* CPU family header for sh4a_nofpu / sh4a_nofpu.
...
#ifndef DEFS_SH4A_NOFPU_H
#define DEFS_SH4A_NOFPU_H
...
// write stacks used in parallel execution
  ...
  // unified writeback function (defined in sh4a_nofpu-write.cc)
  void writeback (int tick, sh4a_nofpu::sh4a_nofpu_cpu* current_cpu);
  // unified write-stack clearing function (defined in sh4a_nofpu-write.cc)
  void reset ();

  }; // end struct sh4a_nofpu::write_stacks 

} // end sh4a_nofpu namespace

#endif /* DEFS_SH4A_NOFPU_H */
