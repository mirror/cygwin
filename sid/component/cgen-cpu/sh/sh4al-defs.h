/* CPU family header for sh4al / sh4al.
...
// write stacks used in parallel execution
  ...
  // unified writeback function (defined in sh4al-write.cc)
  void writeback (int tick, sh4al::sh4al_cpu* current_cpu);
  // unified write-stack clearing function (defined in sh4al-write.cc)
  void reset ();

  }; // end struct sh4al::write_stacks 
