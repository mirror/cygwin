/* CPU family header for sh5 / sh5_compact.
...
#ifndef DEFS_SH5_COMPACT_H
#define DEFS_SH5_COMPACT_H
...
// write stacks used in parallel execution
  ...
  // unified writeback function (defined in sh5_compact-write.cc)
  void writeback (int tick, sh5::sh5_cpu* current_cpu);
  // unified write-stack clearing function (defined in sh5_compact-write.cc)
  void reset ();

  }; // end struct sh5_compact::write_stacks 

} // end sh5_compact namespace

#endif /* DEFS_SH5_COMPACT_H */
