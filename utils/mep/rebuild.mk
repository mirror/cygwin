...
mep-rebuild-gcc: all-binutils all-gas all-ld mep-reconfig-gcc
	...
	if [ -f ./$${dir}/Makefile-not-yet ] ; then \
	  ...
	  ln -s `namei $(exec_prefix) | awk '/^ l / { print $$4 }' | sed s,sources,comp/mep-031021-branch,`/bin/mep-elf-gcc $(exec_prefix)/bin/mep-elf-gcc; \
	fi
...
all-gdb: all-sid
	  ...
	  ln -s `namei $(exec_prefix) | awk '/^ l / { print $$4 }' | sed s,sources,comp/mep-031021-branch,`/bin/mep-elf-gdb $(exec_prefix)/bin/mep-elf-gdb
