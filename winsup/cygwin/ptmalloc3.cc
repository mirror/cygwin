/*
 * $Id: ptmalloc3.cc,v 1.1.2.2 2013/03/11 11:57:15 corinna Exp $
 * 
...
#if 0
/* These two files have been folded into malloc-private.h. */
...
_int_new_arena(size_t size)
{
  ...
  a = (malloc_arena*) CALL_MMAP(mmap_sz);
  if ((char*)a == (char*)-1)
    return 0;
...
{
  const char* s;
  int secure __attribute__ ((unused)) = 0;
...
{
  return mspace_mallinfo(arena_to_mspace(&main_arena));
}
